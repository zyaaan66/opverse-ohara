...
const ARTICLES = [
  ...
  },
  {
    ...
    category: "Teori & Lore",
    author: "Tim Ohara",
    image: "https://www.dexerto.com/cdn-image/wp-content/uploads/2023/06/02/one-piece-void-century-major-incident.jpg",
  ...
  },
  {
    ...
    content: `
      <p>Pertanyaan soal power level antara Admiral dan Yonko sudah diperdebatkan sejak era Marineford, dan sampai sekarang belum benar-benar selesai. Sekarang dengan lebih banyak data dari Final Saga, mari kita analisis lebih dalam.</p>

      <h2>Data dari Marineford</h2>
      <p>Di Perang Puncak Marineford, tiga Admiral (Aokiji, Akainu, Kizaru) berhadapan langsung dengan Whitebeard dan pasukannya. Aokiji bertarung melawan Jozu, Kizaru menghadapi Marco, sementara Akainu — yang terkuat di antara ketiganya — bertarung langsung melawan Whitebeard sendiri. Meski sudah tua, sakit, dan terluka parah, Whitebeard tetap mampu menahan bahkan melukai Akainu sebelum akhirnya gugur.</p>
      <p>Namun banyak yang menekankan bahwa kondisi Whitebeard saat itu jauh dari performa terbaiknya. Untuk melawan pasukan Whitebeard, World Government bahkan sampai perlu mengerahkan seluruh Shichibukai — bukti bahwa tiga Admiral saja dianggap belum cukup untuk menandingi satu Yonko dan armadanya.</p>

      <h2>Bukti Setelah Timeskip: Egghead Island</h2>
      <p>Petunjuk paling konkret justru datang belakangan, di Egghead Island. Ketika Luffy — yang baru saja resmi menjadi Yonko setelah mengalahkan Kaido — berhadapan langsung dengan Admiral Kizaru, ia sempat kewalahan di awal. Namun begitu Luffy mengaktifkan teknik barunya dengan infus Haki Raja (Conqueror's Haki), ia berhasil mengalahkan Kizaru. Banyak yang menganggap momen ini sebagai jawaban paling jelas dari Oda: Yonko secara umum berada di atas level Admiral standar.</p>

      <h2>Kenapa Admiral Terlihat Semakin Dekat?</h2>
      <p>Meski begitu, gap ini tampaknya semakin menyempit di era sekarang. Bounty Cross Guild yang diberikan kepada para Admiral kini mencapai 3-5 miliar berry, setara dengan bounty Luffy sendiri sebagai Yonko. Fleet Admiral Akainu pasca-timeskip bahkan digadang-gadang sudah selevel Yonko, dan banyak fans berspekulasi ia mungkin sudah menguasai Haki Raja seperti pendahulunya, Sengoku.</p>
      <p>Sengoku sendiri sering disebut sebagai contoh bahwa posisi "Fleet Admiral" itu berbeda kelas dari Admiral biasa — ia digambarkan setara dengan legenda-legenda era lama seperti Garp dan bahkan pernah dianggap lawan yang menarik oleh Gol D. Roger.</p>

      <h2>Perdebatan di Komunitas Fans</h2>
      <p>Di forum-forum seperti Reddit dan Fandom, perdebatan ini nyaris tidak pernah berhenti. Sebagian fans berpegang pada argumen "usia": karakter seperti Don Chinjao dan Garp menunjukkan bahwa kekuatan Haki bisa menurun drastis seiring bertambahnya usia. Kubu ini berpendapat Whitebeard yang tua dan sakit saat Marineford bukan representasi Yonko yang sesungguhnya, sehingga performa Admiral sebenarnya lebih rendah dari yang terlihat di perang itu.</p>
      <p>Kubu lain menyoroti bahwa Admiral generasi baru — Fujitora dan Greenbull — justru tampil kurang meyakinkan dibanding tiga Admiral lama. Keduanya gagal menghentikan Tentara Revolusi saat menyelamatkan Bartholomew Kuma, dan Greenbull sempat kesulitan menghadapi sisa-sisa pasukan Beast Pirates yang sudah lemah di Wano — hal yang dianggap seharusnya mudah bagi level setara Yonko.</p>

      <h2>Kesimpulan Sementara</h2>
      <p>Berdasarkan bukti yang ada, level Admiral generasi Akainu-Aokiji-Kizaru bisa dianggap sangat dekat dengan Yonko, terutama dalam pertarungan satu lawan satu. Tapi secara umum, Yonko tetap dianggap unggul karena penguasaan Haki Raja yang lebih matang dan faktor "kekuatan kemauan" yang sering menjadi penentu di pertarungan puncak One Piece — sesuatu yang baru mulai ditunjukkan sebagian Admiral generasi baru.</p>
    `,
  },
  {
    ...
    content: `
      ...
      <h2>5. Hana Hana no Mi — Buah Bunga</h2>
      <p>Dimiliki Nico Robin. Meski terkesan sederhana, kemampuan menumbuhkan bagian tubuh di permukaan apapun ini terbukti sangat serbaguna — dari intel, penyergapan, hingga menciptakan raksasa dari ribuan lengan dan mata sekaligus (Gigantesco Mano dan Cien Fleurs). Buah ini juga penting secara historis karena diyakini berasal dari pohon purba yang tumbuh di reruntuhan Ohara.</p>

      <h2>Perdebatan Fans: Buah Mana yang Sebenarnya Terkuat?</h2>
      <p>Di komunitas online, perdebatan soal buah iblis terkuat hampir selalu berujung pada dua kubu: kubu yang menilai dari skala kehancuran (Gura Gura, Yami Yami) dan kubu yang menilai dari fleksibilitas serta potensi tak terbatas (Ope Ope, Nika). Banyak yang berpendapat kombinasi Gura Gura dan Yami Yami di tubuh Blackbeard sengaja dibuat Oda sebagai ancaman akhir cerita, sementara yang lain yakin Ope Ope tetap yang paling berbahaya karena satu-satunya buah yang bisa "membeli" keabadian.</p>
    `,
  },
  {
    ...
    content: `
      <p>Salah satu tradisi One Piece yang paling dinantikan adalah rekrutmen nakama baru. Setiap anggota Straw Hat membawa keahlian unik dan cerita latar yang dalam. Dengan cerita memasuki Final Saga, siapa yang berpeluang menjadi anggota terakhir?</p>

      <h2>Rekap: Semua yang Pernah Diajak Luffy</h2>
      <p>Menariknya, Luffy sudah mengajak lebih dari 20 karakter untuk bergabung sepanjang cerita, dan tidak semuanya menerima. Beberapa nama yang menolak atau belum sempat menerima antara lain Vivi, Momonosuke, Kinemon, Yamato, hingga yang paling baru: Loki, sang pangeran suku raksasa di Elbaf. Dari daftar panjang ini, komunitas fans membagi mereka menjadi tiga kategori: ajakan bercanda (seperti pohon bicara di Thriller Bark), ajakan simbolis yang jelas tak akan pernah terwujud (Ace, Sabo), dan ajakan serius yang masih punya peluang terjadi.</p>

      <h2>Kandidat Terkuat: Yamato</h2>
      <p>Yamato sudah mendeklarasikan dirinya sebagai "Kozuki Oden" dan ingin ikut berlayar seperti Oden dulu. Dengan kekuatan Mythical Zoan Inu Inu no Mi Model Okuchi no Makami, dia adalah salah satu karakter terkuat yang pernah hampir bergabung dengan Straw Hat, dan hanya tertahan karena harus menjaga Wano bersama Momonosuke.</p>

      <h2>Dark Horse: Loki, Pangeran Elbaf</h2>
      <p>Ajakan terbaru dan paling ramai dibicarakan adalah Loki, pangeran suku raksasa dari Elbaf. Berbeda dengan ajakan-ajakan sebelumnya yang terasa simbolis, tawaran untuk Loki dianggap banyak fans sebagai salah satu yang paling serius karena datang di tengah momentum arc yang sedang fokus membangun hubungannya dengan Luffy. Di forum-forum diskusi, sebagian fans skeptis dan membandingkannya dengan Carrot serta Bonney yang juga sempat digadang-gadang tapi akhirnya tidak jadi bergabung permanen — sementara sebagian lain yakin pola "gagal" itu justru akan dipatahkan Loki.</p>

      <h2>Kandidat yang Tak Boleh Dilupakan: Vivi</h2>
      <p>Di antara semua kandidat lama, Vivi tetap dianggap sebagai kasus paling unik. Ia sudah punya sejarah panjang dan ikatan emosional kuat dengan kru sejak arc Alabasta, sehingga menurut banyak fans, Oda tidak perlu lagi membangun karakter dari nol seperti kandidat lainnya jika suatu saat memutuskan untuk benar-benar memasukkannya secara resmi ke kru.</p>

      <h2>Kesimpulan Sementara</h2>
      <p>Dengan cerita yang semakin mendekati akhir, kemungkinan besar Oda hanya akan menambahkan satu atau dua nakama lagi secara resmi — atau bahkan tidak sama sekali, dan menjadikan karakter-karakter ini sekutu dalam armada besar Straw Hat alih-alih anggota inti. Yang jelas, momen "拾う" (memungut nakama) selalu menjadi salah satu bagian paling emosional dari seri ini, dan fans akan terus menantikannya sampai bab terakhir.</p>
    `,
  },
  {
    ...
    content: `
      <p>Grand Line adalah jantung dari cerita One Piece. Rute yang membelah dunia dari barat ke timur, memotong tegak lurus Red Line, ini dikenal sebagai "kuburan para bajak laut" sekaligus "surga" bagi mereka yang cukup kuat untuk bertahan. Apa yang membuatnya begitu istimewa?</p>

      <h2>Anomali Magnetik dan Log Pose</h2>
      <p>Grand Line memiliki medan magnet yang sangat kuat dan tidak stabil di setiap pulaunya, membuat kompas biasa sama sekali tidak berfungsi. Itulah mengapa navigator membutuhkan Log Pose — kompas khusus yang merekam medan magnet sebuah pulau, lalu menunjuk arah ke pulau berikutnya begitu medan magnet itu selesai "terkunci". Uniknya, Log Pose hanya bisa menunjuk maju, tidak bisa dipakai untuk kembali ke pulau sebelumnya, sehingga secara alami memaksa setiap pelaut untuk terus melaju ke depan.</p>
      <p>Ada juga varian bernama Eternal Pose, yang terkunci permanen pada satu pulau tertentu dan tidak pernah reset — sangat berharga karena bisa digunakan kapan saja untuk kembali ke pulau yang sama tanpa harus mengikuti jalur Log Pose biasa.</p>

      <h2>Calm Belt: Gerbang yang Nyaris Mustahil Ditembus</h2>
      <p>Di sisi utara dan selatan Grand Line terdapat Calm Belt, wilayah laut tanpa arus, tanpa angin, dan tanpa gelombang sama sekali — membuat kapal layar biasa mustahil bergerak di sana. Ditambah lagi, wilayah ini adalah rumah bagi Sea King-Sea King terbesar di seluruh dunia One Piece. Kombinasi inilah yang membuat nyaris tidak ada yang bisa masuk atau keluar Grand Line secara langsung, kecuali lewat dua titik resmi: Reverse Mountain dan Mary Geoise.</p>

      <h2>Cuaca yang Mustahil</h2>
      <p>Di Grand Line, badai salju dan cuaca panas terik bisa terjadi bergantian dalam waktu singkat di pulau yang sama. Fenomena seperti Knock-Up Stream — arus dahsyat yang bisa melontarkan kapal utuh ke udara — juga menjadi bagian dari keunikan geografis kawasan ini yang menantang logika alam biasa.</p>

      <h2>New World: Level Berikutnya</h2>
      <p>Bagian kedua Grand Line — New World — bahkan jauh lebih ekstrem, sampai-sampai bagian pertama Grand Line dijuluki "Paradise" hanya untuk membandingkan betapa lebih berbahayanya New World. Di sini, Log Pose standar dengan satu jarum tidak lagi cukup, karena medan magnet pulau-pulaunya bisa berubah-ubah bahkan menghilang secara acak. Dibutuhkan New World Log Pose yang punya tiga jarum sekaligus, masing-masing mengunci ke pulau berbeda sebagai cadangan — jadi kalau satu pulau kehilangan medan magnetnya, pelaut masih punya dua opsi lain untuk diikuti.</p>
      <p>Di ujung New World, terdapat Laugh Tale — pulau terakhir dalam rute Grand Line, tempat harta karun legendaris One Piece dan Rio Poneglyph konon berada. Hanya kru Gol D. Roger yang tercatat berhasil menjelajahi seluruh Grand Line dan mencapainya.</p>

      <h2>Kesimpulan</h2>
      <p>Grand Line bukan sekadar lautan biasa — ia adalah ujian yang dirancang oleh alam (dan mungkin, oleh sejarah Void Century) untuk menyaring siapa saja yang benar-benar pantas mencapai Laugh Tale. Kombinasi antara Log Pose, Calm Belt, dan cuaca ekstrem menjadikannya salah satu world-building paling matang dalam sejarah manga.</p>
    `,
  },
];
